...
#' @param method 
#'
#' @return The SL_pairs tibble with the survival coefficient column
#' 
#'
#' @examples SL_pairs <- survival_filter(SL_pairs)
survival_filter <- function(SL_pairs, cancer_type = "pan-cancer", method = "cox"){
